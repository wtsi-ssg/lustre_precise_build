...
cat /vagrant/lustre/changes/patches/ext4-mmp.patch.patch  | patch ./ldiskfs/kernel_patches/patches/rhel6.4/ext4-mmp.patch
cat /vagrant/lustre/changes/patches/ldlm_lockd.c.patch    | patch ./lustre/ldlm/ldlm_lockd.c
cat /vagrant/lustre/changes/patches/o2iblnd_cb.c.patch    | patch ./lnet/klnds/o2iblnd/o2iblnd_cb.c
cat /vagrant/lustre/changes/patches/ptlrpcd.c.patch       | patch ./lustre/ptlrpc/ptlrpcd.c
cat /vagrant/lustre/changes/patches/qsd_reint.c.patch     | patch ./lustre/quota/qsd_reint.c
cat /vagrant/lustre/changes/patches/service.c.patch       | patch ./lustre/ptlrpc/service.c
cat /vagrant/lustre/changes/patches/socklnd_cb.c.patch    | patch ./lnet/klnds/socklnd/socklnd_cb.c
cat /vagrant/lustre/changes/patches/workitem.c.patch      | patch ./libcfs/libcfs/workitem.c
...
cat /vagrant/lustre/changes/patches/Makefile.patch | patch Makefile 
...
cat /vagrant/lustre/changes/patches/arch_x86_vdso_Makefile.patch | patch arch/x86/vdso/Makefile
...
cat /vagrant/lustre/changes/patches/config.patch | patch -R  .config
