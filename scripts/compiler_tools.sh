...
apt-get -y install linux-image-3.2.0-75-generic linux-headers-3.2.0-75-generic linux-tools-3.2.0-75 linux-image-3.8.0-44-generic linux-headers-3.8.0-44-generic linux-tools-3.8.0-44  gcc-4.4 
