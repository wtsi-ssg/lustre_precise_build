...
tar xf /vagrant/lustre/downloads/linux-2.6.32-573.3.1.el6.x86_64.tar.gz
...
if [ "${LUSTREVER}" = "lustre-2.5.39-ddn-1" ] ; then
 tar xvf   /vagrant/lustre/downloads/Sanger-lustre-2.5.39.tar.gz
 mv lustre-2.5.39 "${LUSTREVER}"
fi
if [ "${LUSTREVER}" = "lustre-2.5.39-ddn-3" ] ; then
...
mv /vagrant/lustre/downloads/tmp/linux-2.6.32-573.3.1.el6.x86_64  /vagrant/lustre/source/
