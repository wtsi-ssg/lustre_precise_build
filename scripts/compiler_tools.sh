...
#sleep 999999
apt-get update
apt-get -y install alien quilt kernel-package fakeroot subversion autotools-dev   module-assistant cvs  automake libtool linux-headers-$(uname -r)  git gcc-4.4 

# Lets try and look like redhat
apt-get -y purge  gcc-4.8
